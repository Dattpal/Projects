<?php 
    ...
    if(isset($_POST['submit'])){
       ...
       // $res=false;
        $insert_query="INSERT INTO `vehicle`(`veh_id`, `veh_reg`, `veh_type`, `chesisno`, `brand`, `veh_color`, `veh_regdate`, `veh_description`, `veh_photo`, `veh_available`) VALUES (NULL ,'$regno','$type','$chesisno','$brand','$color','$regdate','$description','$photo', 1)";
       ...
       <div class="col-md-3">
        ...
        <div class="col-md-6 animated bounceIn"> 
            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="input-group">
                  <span class="input-group-addon"><b>services Type</b></span>
                  <label class="radio-inline">
                      <input type="radio" name="type" value="bus"> Full wash
                    </label>
                    <label class="radio-inline">
                      <input type="radio" name="type" value="bus">Engine Wash
                    </label>
                <label class="radio-inline">
                  <input type="radio" name="type" value="car">Car polish
                </label>
                <label class="radio-inline">
                      <input type="radio" name="type" value="bus">Interior polish
                    </label>
                </div>
                <br>
                <div class="input-group">
                ...
                <div class="input-group">
                  ...
                  <input id="vehcolor" type="text" class="form-control" name="vehchesis" placeholder="Chesis no">
                </div>
                <br>
