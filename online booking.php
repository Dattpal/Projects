    ...
    <body>
         ...
         <div class="topbar">
          ...
          <div class="cont-wrapper">
             <img src="css/images/booking2.jpeg" alt="home img">
            ...
            <div class="book-cont">
                <div class="tab">
                    ...
                    <div class="add">
                    <a href="admin\booking.php"><button type="button" name="btn">Order Now <i class="fas fa-arrow-circle-right"></i></button></a>
                    </div>
                </div>
                <div class="tab">
                    <div class="tab-header">
                        <div class="name">
                            <h1>Sedan-car services</h1>
                        </div>
                        <div class="price">
                            <h2>350rs </h2>
                            <span><i class="far fa-clock"></i> 20 MINUTES</span>
